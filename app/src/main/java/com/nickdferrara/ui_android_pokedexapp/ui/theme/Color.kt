package com.nickdferrara.ui_android_pokedexapp.ui.theme

import androidx.compose.ui.graphics.Color

val darkPrimaryColor = Color.Yellow
val darkBackgroundColor = Color(0xFF101010)
val darkOnBackgroundColor = Color.White
val darkSurface = Color(0xFF303030)
val darkOnSurface = Color.White

val lightPrimaryColor = Color.Blue
val lightBackgroundColor = Color(0xFFBAC7FF)
